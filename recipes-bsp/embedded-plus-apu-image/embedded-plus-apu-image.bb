...
cat > ${WORKDIR}/${PN}.bif << EOF
    all:
    {
        ...
        image { 
            ...
            { load=0x2000000, file=${DEPLOY_DIR_IMAGE}/embedded-plus-image-minimal-embedded-plus-ve2302.cpio.gz.u-boot }
...
do_compile[depends] += " \
    ...
    embedded-plus-image-minimal:do_image_complete \
